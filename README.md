...
Feel free to check the [issues page](https://github.com/monicah79/Book-store/issues).
...
This project is [MIT](https://github.com/monicah79/Book-store/blob/initialize-with-components/License) licensed.
